...
import { TimeCorrectionManagement } from '@/components/time-correction-management-new';
...
export default function AdminPage() {
  ...
  const [activeTab, setActiveTab] = useState<'analytics' | 'employees' | 'auto-clockout' | 'time-corrections' | 'reports'>('analytics');
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 p-6">
      ...
      {/* Reports Tab */}
      {activeTab === 'reports' && (
        <EmployeeReport adminId={admin.id} />
      )}
    </div>
  );
}